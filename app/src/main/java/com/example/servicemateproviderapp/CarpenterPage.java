...
public class CarpenterPage extends AppCompatActivity implements NavigationBarView.OnItemReselectedListener {


    ListView list1;
    Button btn1;
    BottomNavigationView bnv;
    String[] listDemo={"clow hamers","Top measures","Measuring squares","Bed repairs","Wood and door installation","Bath feating installation","Others"};
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_carpenter_page);
