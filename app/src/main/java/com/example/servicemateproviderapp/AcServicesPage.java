...
public class AcServicesPage extends AppCompatActivity implements NavigationBarView.OnItemReselectedListener {
    ListView list1;
    Button btn1;
    BottomNavigationView bnv;
    String[] listDemo={"Split AC full service","window AC full service","Split AC gas filling","Window AC gas filling","Split AC repair","window AC repair","Others"};

    @SuppressLint("MissingInflatedId")
    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_ac_services_page);
