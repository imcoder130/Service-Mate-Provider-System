...
public class PestControlPage extends AppCompatActivity implements NavigationBarView.OnItemReselectedListener {

    ListView list1;
    Button btn1;
    BottomNavigationView bnv;
    String[] listDemo={"Biotogical pest control","Hygiene control","Chemical pest control","Physical pest control","cutural pest control","Get pest control service","Others"};
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_pest_control_page);
