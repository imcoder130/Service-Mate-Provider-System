...
public class PlumberPage extends AppCompatActivity implements NavigationBarView.OnItemReselectedListener {

    ListView list1;
    Button btn1;
    BottomNavigationView bnv;
    String[] listDemo={"Wash Basin service","Indian toilet installation","Underground and above ground installation","General piumber works","Western toilet service","Bathroom fitting repair and installation","Others"};
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        ArrayAdapter<String> arrayAdapter = new
                ArrayAdapter<>(getApplicationContext(), android.R.layout.simple_list_item_multiple_choice,
                listDemo);
