...
public class PvcFloorPage extends AppCompatActivity implements NavigationBarView.OnItemReselectedListener {
    ListView list1;
    Button btn1;
    BottomNavigationView bnv;
    String[] listDemo={"LVT","Sheet Vinyl","PVC carpet","Plash floor","PVC tiles","Brown PVC flooring","Others"};
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_pvc_floor_page);
