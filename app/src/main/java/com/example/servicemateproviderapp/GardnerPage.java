...
public class GardnerPage extends AppCompatActivity implements NavigationBarView.OnItemReselectedListener {

    ListView list1;
    Button btn1;
    BottomNavigationView bnv;
    String[] listDemo={"Garden cutting","Garden cleaning","Moving grass","Trimming grass and brushes","Maintaining planting beds","Farm labarer","Others"};
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_gardner_page);
